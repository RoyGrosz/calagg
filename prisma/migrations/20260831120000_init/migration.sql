...
CREATE TABLE "CalendarRef" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "CalendarRef_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "GoogleAccount" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "SyncRoute" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "SyncRoute_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "SyncRoute_sourceCalId_fkey" FOREIGN KEY ("sourceCalId") REFERENCES "CalendarRef" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "SyncRoute_targetCalId_fkey" FOREIGN KEY ("targetCalId") REFERENCES "CalendarRef" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "EventMap" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "EventMap_routeId_fkey" FOREIGN KEY ("routeId") REFERENCES "SyncRoute" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
