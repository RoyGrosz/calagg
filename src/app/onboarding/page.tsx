    ...
    <AppShell>
      ...
      {step === 2 && (
        <section className="card p-6">
          ...
          <p className="mt-1 text-sm text-mist-500">
            EchoCal never writes to Primary. Use a dedicated calendar such as “From other calendars”.
          </p>
          {target && (
      ...
      {step === 5 && (
        <section className="card p-6">
          ...
          <p className="mt-1 text-sm text-mist-500">
            EchoCal is listing source events (±3 months) and upserting onto the target.
          </p>
